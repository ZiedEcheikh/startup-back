...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {
                label: 'Paramétrage', icon: 'pi pi-fw pi-star', routerLink: ['/administrator/market'],
                items: [
                    { label: 'Ventes', icon: 'pi pi-fw pi-th-large', routerLink: ['/administrator/market/sale-add'] }
                ]
            }
        ];
    }

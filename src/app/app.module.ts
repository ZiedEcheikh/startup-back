...
import { AppLodingComponent, LoadingService } from './theme';
...
@NgModule({
    ...
    providers: [
        { provide: LocationStrategy, useClass: HashLocationStrategy }, LoadingService, LoadingPageService, MessageService
    ],
